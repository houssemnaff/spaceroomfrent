...
export default function Login2() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      login(data.user, data.token); // Utilisation de l'authContext
    } catch (err) {
...
const handleSignInWithMail = async () => {
  setLoading(true);
  setError("");
  try {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <form onSubmit={handleSignInWithMail} className="flex flex-col gap-6">
